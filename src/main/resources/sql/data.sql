...
-- ================================= 전문가테이블 샘플 코드  =================================
INSERT INTO expert (expertId, expertName, expertNumber, expertEmail, expertState, createDate, updateDate)
VALUES (1, '김민준', '010-1234-5678', 'minjun.kim@arbo.co.kr', '활동중', now(),now()),
       ...
       (56, '강지호', '010-4444-5555', 'jiho.kang@arborist.co.kr',  '퇴직', now(), now()),
