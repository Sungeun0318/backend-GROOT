...
VALUES (1, 1, 1, 1, '진행중', '여수 공장 견적 확인 요청', '2026-04-01', '2026-04-10', '2026-04-13', NOW(), NOW()),
       (2, 2, 2, NULL, '신청', '소나무 150 그루 초기 답사', '2026-04-02', '2026-04-11', '2026-04-15', NOW(), NOW()),
       (3, 3, 3, 1, '완료', '지점 견적 확인 요청', '2026-03-01', '2026-03-05', '2026-03-08', '2026-03-01', NOW()),
       (4, 4, 4, 2, '진행중', '참나무 300 그루 수량 파악', '2026-04-02', '2026-04-11', '2026-04-15', NOW(), NOW()),
       (5, 5, 5, NULL, '신청', '탄소 배출권 견적 요청', '2026-04-03', '2026-04-12', '2026-04-16', NOW(), NOW()),
       (6, 6, 6, 1, '완료', '단풍나무 50 그루 상태 확인', '2026-03-02', '2026-03-07', '2026-03-11', '2026-03-02', NOW()),
       (7, 7, 7, 0, '진행중', '시설 안전 답사 요청', '2026-04-03', '2026-04-12', '2026-04-16', NOW(), NOW()),
       (8, 8, 8, NULL, '신청', '신규 지점 견적 확인 요청', '2026-04-04', '2026-04-13', '2026-04-17', NOW(), NOW()),
       (9, 9, 9, 3, '완료', '느티나무 100 그루 초기 답사', '2026-03-05', '2026-03-10', '2026-03-14', '2026-03-05', NOW()),
       (10, 10, 10, 1, '진행중', '지사 견적 확인 요청', '2026-04-04', '2026-04-13', '2026-04-17', NOW(), NOW()),
       (11, 1, 11, NULL, '신청', '마포 인근 견적 확인 요청', '2026-04-05', '2026-04-14', '2026-04-18', NOW(), NOW()),
       (12, 2, 12, 0, '진행중', '편백나무 250 그루 수량 파악', '2026-04-05', '2026-04-14', '2026-04-18', NOW(), NOW()),
       (13, 3, 13, 1, '완료', '대구 인근 견적 확인 요청', '2026-03-06', '2026-03-12', '2026-03-16', '2026-03-06', NOW()),
       (14, 4, 14, 1, '완료', '은행나무 80 그루 초기 답사', '2026-03-08', '2026-03-15', '2026-03-19', '2026-03-08', NOW()),
       (15, 5, 15, NULL, '신청', '설비 교체 견적 요청', '2026-04-06', '2026-04-15', '2026-04-20', NOW(), NOW()),
       (16, 6, 1, 2, '완료', '나주 공장 견적 확인 요청', '2026-03-10', '2026-03-20', '2026-03-23', '2026-03-10', NOW()),
       (17, 7, 16, 0, '진행중', '단풍나무 120 그루 상태 확인', '2026-04-07', '2026-04-16', '2026-04-20', NOW(), NOW()),
       (18, 8, 17, NULL, '신청', '과천 지역 견적 확인 요청', '2026-04-07', '2026-04-16', '2026-04-20', NOW(), NOW()),
       (19, 9, 18, 0, '완료', '판교 지사 견적 확인 요청', '2026-03-12', '2026-03-22', '2026-03-26', '2026-03-12', NOW()),
       (20, 10, 19, 1, '진행중', '감귤나무 400 그루 초기 답사', '2026-04-08', '2026-04-17', '2026-04-21', NOW(), NOW()),
       (21, 1, 20, NULL, '신청', '평택 공장 견적 확인 요청', '2026-04-09', '2026-04-18', '2026-04-22', NOW(), NOW()),
       (22, 2, 21, 2, '완료', '잣나무 200 그루 수량 파악', '2026-03-15', '2026-03-25', '2026-03-29', '2026-03-15', NOW()),
       (23, 3, 22, 1, '진행중', '당진 공장 견적 확인 요청', '2026-04-09', '2026-04-18', '2026-04-22', NOW(), NOW()),
       (24, 4, 23, NULL, '신청', '원주 지점 견적 확인 요청', '2026-04-10', '2026-04-19', '2026-04-23', NOW(), NOW()),
       (25, 5, 24, 1, '완료', '배나무 300 그루 초기 답사', '2026-03-18', '2026-03-28', '2026-04-01', '2026-03-18', NOW()),
       (26, 6, 25, 1, '진행중', '익산 지사 견적 확인 요청', '2026-04-10', '2026-04-19', '2026-04-23', NOW(), NOW()),
       (27, 7, 26, NULL, '신청', '주목 150 그루 상태 확인', '2026-04-10', '2026-04-20', '2026-04-24', NOW(), NOW()),
       (28, 8, 27, 1, '진행중', '포항 공장 견적 확인 요청', '2026-04-11', '2026-04-20', '2026-04-24', NOW(), NOW()),
       (29, 9, 28, NULL, '신청', '창원 지점 견적 확인 요청', '2026-04-11', '2026-04-21', '2026-04-25', NOW(), NOW()),
       (30, 10, 29, 3, '완료', '측백나무 200 그루 수량 파악', '2026-02-20', '2026-03-01', '2026-03-05', '2026-02-20', NOW()),
       (31, 1, 30, 1, '진행중', '진주 지점 견적 확인 요청', '2026-04-12', '2026-04-21', '2026-04-25', NOW(), NOW()),
       (32, 2, 31, NULL, '신청', '소나무 350 그루 초기 답사', '2026-04-12', '2026-04-22', '2026-04-26', NOW(), NOW()),
       (33, 3, 32, 2, '완료', '천안 지점 견적 확인 요청', '2026-02-21', '2026-03-02', '2026-03-06', '2026-02-21', NOW()),
       (34, 4, 33, 1, '진행중', '성남 지점 견적 확인 요청', '2026-04-13', '2026-04-22', '2026-04-26', NOW(), NOW()),
       (35, 5, 34, 0, '완료', '상수리나무 100 그루 초기 답사', '2026-02-22', '2026-03-03', '2026-03-07', '2026-02-22', NOW()),
       (36, 6, 35, NULL, '신청', '용인 지사 견적 확인 요청', '2026-04-13', '2026-04-23', '2026-04-27', NOW(), NOW()),
       (37, 7, 1, 2, '진행중', '전나무 180 그루 수량 파악', '2026-04-14', '2026-04-23', '2026-04-27', NOW(), NOW()),
       (38, 8, 2, 1, '완료', '군포 지점 견적 확인 요청', '2026-02-23', '2026-03-04', '2026-03-08', '2026-02-23', NOW()),
       (39, 9, 3, NULL, '신청', '가문비나무 220 그루 초기 답사', '2026-04-14', '2026-04-24', '2026-04-28', NOW(), NOW()),
       (40, 10, 4, 1, '진행중', '김포 공장 견적 확인 요청', '2026-04-15', '2026-04-24', '2026-04-28', NOW(), NOW()),
       (41, 1, 5, 3, '완료', '느티나무 140 그루 상태 확인', '2026-02-25', '2026-03-05', '2026-03-09', '2026-02-25', NOW()),
       (42, 2, 6, 1, '진행중', '의왕 공장 견적 확인 요청', '2026-04-16', '2026-04-25', '2026-04-29', NOW(), NOW()),
       (43, 3, 7, NULL, '신청', '소나무 300 그루 초기 답사', '2026-04-16', '2026-04-25', '2026-04-29', NOW(), NOW()),
       (44, 4, 8, 0, '진행중', '양주 공장 견적 확인 요청', '2026-04-17', '2026-04-26', '2026-04-30', NOW(), NOW()),
       (45, 5, 9, 1, '완료', '자작나무 400 그루 수량 파악', '2026-02-26', '2026-03-07', '2026-03-11', '2026-02-26', NOW()),
       (46, 6, 10, NULL, '신청', '파주 공장 견적 확인 요청', '2026-04-17', '2026-04-27', '2026-05-01', NOW(), NOW()),
       (47, 7, 11, 2, '진행중', '벚나무 150 그루 상태 확인', '2026-04-18', '2026-04-27', '2026-05-01', NOW(), NOW()),
       (48, 8, 12, 1, '완료', '포천 공장 견적 확인 요청', '2026-03-01', '2026-03-10', '2026-03-14', '2026-03-01', NOW()),
       (49, 9, 13, NULL, '신청', '탄소 배출량 측정 요청', '2026-04-19', '2026-04-28', '2026-05-02', NOW(), NOW()),
       (50, 10, 14, 1, '진행중', '기존 공장 재답사 요청', '2026-04-19', '2026-04-28', '2026-05-02', NOW(), NOW());
-- ================================= 답사정보 샘플 코드  =================================
