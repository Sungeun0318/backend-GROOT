...
-- ================================= 기업 샘플 데이터 =================================
INSERT INTO company (company_id, company_name, business_number, ceo_name, start_date, address, business_license, is_approved, create_date, update_date)
VALUES
(1,  '삼성전자',       '124-81-00998', '이재용',  '19690113', '경기도 수원시 영통구 삼성로 129', null, 1, now(), now()),
...
INSERT INTO member (member_id, company_id, member_name, password, party_name, company_number, email, address, is_approved, is_admin, create_date, update_date)
VALUES
(1,  4,  'tech_vision_01',   '$2b$12$f8tJbai9YbFKqWWpYWoNRuZ5uamT.AsjSHp3LHvQsv22ydxDhzx4m', '김도윤', '010-2938-1029', 'dy.kim@techvision.co.kr',    '서울특별시 강남구 테헤란로 427',       1, 0, now(), now()),
(2,  1,  'blue_ocean_intl',  '$2b$12$O9WT/AW9ooIy8Jj72XQ4Tu/bZG6wjdeM5VNtxGmvtnxlR.TluOyba', '이현우', '010-8821-3304', 'hwlee@blueocean.com',        '경기도 성남시 분당구 판교역로 166',    1, 0, now(), now()),
(3,  9,  'green_farm_korea', '$2b$12$PF4Fps0hjrM5tvCKpcOZduwfyff57Z409jrWcHIJsYzfLiohpW1su', '박서준', '010-4456-7812', 'seo_jun@greenfarm.kr',       '전라남도 나주시 빛가람로 350',         0, 0, now(), now()),  -- 대기
(4,  8,  'smart_logic_lab',  '$2b$12$oD9n6kltZn7o1jx42UTMV.tW39iCAfbLZYD55zojMmKjQcR3530G.', '최하은', '010-5567-1123', 'haeun.choi@smartlogic.io',   '서울특별시 구로구 디지털로 300',       1, 0, now(), now()),
(5,  8,  'global_logis_sys', '$2b$12$GjE1DXPbN0Rewnw48kAMUeVHi8dqbs.DwLUGXljO49CO9S4atSQ9e', '정민호', '010-9901-2234', 'mh.jung@globallogis.net',    '부산광역시 강서구 유통단지로 23',      1, 0, now(), now()),
(6,  5,  'future_mob_dev',   '$2b$12$2wyWMuTCcev4F8vK2eXWWeOH15bWdG5G7heAI0P94o84oMsHwyqnO', '강지안', '010-3345-6678', 'jian.kang@futuremob.co.kr',  '경기도 화성시 삼성로 1',               1, 0, now(), now()),
(7,  4,  'creative_ads_kr',  '$2b$12$/Fm2MH/0m72OWcawU99xYO0wkIL1E/3hfygLbH9UF1zRUHHoNoJcy', '윤소희', '010-7788-9901', 'sh.yoon@creativeads.com',    '서울특별시 마포구 양화로 144',         0, 0, now(), now()),  -- 대기
(8,  18, 'health_care_plus', '$2b$12$3CVA8FiSqXsK1tctusmVB.MNT1mFQZP/pUztkdS/BEJwiKSelpjIm', '한준영', '010-2211-4433', 'jy.han@healthcareplus.kr',   '대구광역시 중구 달구벌대로 2077',      1, 0, now(), now()),
(9,  3,  'urban_design_st',  '$2b$12$nyQ/DHK3oxcxlcZqp9Hh0Os7i0/CHn.V8p9X/w7w89AFXKoV2eOrm', '송미경', '010-6655-1100', 'mk.song@urbandesign.co.kr',  '서울특별시 성동구 성수이로 113',       1, 0, now(), now()),
(10, 19, 'mega_store_dist',  '$2b$12$WHmlmkL1Q/DpRDpkpJGnNOTI1zfqV6SL2hvlNmioL4kD1Cx2dUxt2', '임재상', '010-4499-8822', 'js.lim@megastore.co.kr',     '인천광역시 부평구 부평대로 20',        1, 0, now(), now()),
(11, 14, 'cloud_infra_sol',  '$2b$12$jK.Lt0/ccdbhvPe3yo.7U.vEZ3kjf4NnpymKRYEraPTzTWA7TH95O', '박준영', '010-3388-1122', 'jy.park@cloudinfra.co.kr',   '서울특별시 서초구 서초대로 301',       0, 0, now(), now()),  -- 대기
(12, 2,  'neo_medical_kr',   '$2b$12$9S0KE7OZEK1VXU8JDiHhqetKid9ALxbMIUu5xa/vE7CD5I.DBuHlO', '이서연', '010-7744-8899', 'sy.lee@neomed.kr',            '경기도 수원시 영통구 광교중앙로',      1, 0, now(), now()),
(13, 1,  'atlas_heavy_ind',  '$2b$12$aYk4tkfH7VYB6pXDUsh8qeqOLU63LdAH8vSKeQiPzzukbl6f29Kp6', '최동현', '010-2211-5544', 'dh.choi@atlasind.com',       '울산광역시 동구 방어진순환도로',       1, 0, now(), now()),
(14, 3,  'vision_it_group',  '$2b$12$pfRbPDBsoQoHvmkP4n0aAu0q7McZhStUQt2likCj0YGES0iUMomVa', '김민지', '010-4455-2233', 'mj.kim@visionit.io',         '서울특별시 금천구 가산디지털1로',      1, 0, now(), now()),
(15, 7,  'k_logistics_net',  '$2b$12$7dN/O6tBHe4zm2aOBR412uw51uTKhP/aDqQ/jy5.gU0UAMByOK3fa', '정태우', '010-9988-7766', 'tw.jung@klogis.net',         '인천광역시 중구 공항동로 295',         1, 0, now(), now()),
(16, 8,  'urban_re_mgt',     '$2b$12$2fNrxcVvgmgeILczuTJfM.Dp9uBkoexJeQCD.JywQdrt9Fl3v4oFK', '황수진', '010-1133-4422', 'sj.hwang@urbanmgt.co.kr',    '서울특별시 종로구 율곡로 6',           1, 0, now(), now()),
(17, 17, 'eco_power_tech',   '$2b$12$JYQLo0cN1xdtlXTq736bse2rl8gXq593rqXswr83RYPrZnT6v.5Bu', '안재현', '010-5566-3311', 'jh.ahn@ecopower.kr',         '전라남도 나주시 전력로 11',            1, 0, now(), now()),
(18, 20, 'global_edu_plus',  '$2b$12$.yYKJ6N8iAiXQubn2sSdseeCyEF7auTFosFkCtwGhWLn/PoAvgjHW', '윤하은', '010-8811-9922', 'he.yoon@eduplus.com',        '서울특별시 강남구 역삼로 415',         1, 0, now(), now()),
(19, 1,  'smart_iot_lab',    '$2b$12$78ZIBwoR9EjnReyCbHS/Fu9Z2Yn4EU2GfJgLvJRAqqHU8S2NrVG7y', '박성민', '010-2244-6688', 'sm.park@smartiot.io',        '경기도 성남시 수정구 창업로 40',       1, 0, now(), now()),
(20, 18, 'prime_food_sys',   '$2b$12$zIaarbB2t4z0q9myCXGqqu6YC.n/ZDhz97S1nBzDIw/980d.ABnRy', '강도윤', '010-7799-1155', 'dy.kang@primefood.co.kr',    '충청북도 음성군 원남면 원남산단로',    1, 0, now(), now()),
-- 관리자 계정 (비밀번호: admin1234)
(21, 1,  'admin',            '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lHHG', '관리자', '010-0000-0000', 'admin@greenzone.com',        '서울특별시 강남구 테헤란로 427',       1, 1, now(), now());
-- ================================= 전문가테이블 샘플 코드  =================================
...
values
    (1, '소나무', 25, '양호', 'https://picsum.photos/seed/tree1/400/300', 12, 8, 37.5665000, 126.9780000, now(), now()),
    ...
    (5, '메타세쿼이아', 40, '양호', 'https://picsum.photos/seed/tree10/400/300', 25, 7, 36.3510000, 127.3852000, now(), now()),
    ...
    (7, '느티나무', 55, '양호', 'https://picsum.photos/seed/tree13/400/300', 22, 14, 37.2636000, 127.0286000, now(), now()),
    (7, '벚나무', 25, '불량', 'https://picsum.photos/seed/tree14/400/300', 10, 6, 37.2642000, 127.0300000, now(), now()),
    (8, '은행나무', 38, '보통', 'https://picsum.photos/seed/tree15/400/300', 16, 10, 35.1595000, 126.8526000, now(), now()),
    ...
    (11, '느릅나무', 35, '보통', 'https://picsum.photos/seed/tree21/400/300', 15, 9, 36.0190000, 129.3435000, now(), now()),
    (11, '소나무', 29, '양호', 'https://picsum.photos/seed/tree22/400/300', 13, 8, 36.0201000, 129.3442000, now(), now()),
    (12, '메타세쿼이아', 45, '양호', 'https://picsum.photos/seed/tree23/400/300', 28, 8, 35.8242000, 127.1480000, now(), now()),
    (12, '벚나무', 22, '보통', 'https://picsum.photos/seed/tree24/400/300', 10, 7, 35.8250000, 127.1491000, now(), now()),
    (13, '은행나무', 50, '양호', 'https://picsum.photos/seed/tree25/400/300', 20, 13, 36.6357000, 127.4917000, now(), now()),
    (13, '참나무', 33, '양호', 'https://picsum.photos/seed/tree26/400/300', 16, 10, 36.6365000, 127.4923000, now(), now()),
    ...
    (15, '자작나무', 20, '양호', 'https://picsum.photos/seed/tree29/400/300', 11, 6, 37.8854000, 127.7298000, now(), now()),
    (15, '느티나무', 48, '보통', 'https://picsum.photos/seed/tree30/400/300', 19, 12, 37.8861000, 127.7312000, now(), now()),
    ...
    (17, '참나무', 38, '양호', 'https://picsum.photos/seed/tree34/400/300', 17, 11, 37.6591000, 126.8335000, now(), now()),
    (18, '벚나무', 19, '양호', 'https://picsum.photos/seed/tree35/400/300', 9, 6, 36.8151000, 127.1139000, now(), now()),
    (18, '은행나무', 42, '보통', 'https://picsum.photos/seed/tree36/400/300', 17, 11, 36.8163000, 127.1147000, now(), now()),
    (19, '느티나무', 62, '양호', 'https://picsum.photos/seed/tree37/400/300', 23, 16, 35.9677000, 126.7369000, now(), now()),
    (19, '단풍나무', 21, '양호', 'https://picsum.photos/seed/tree38/400/300', 10, 6, 35.9685000, 126.7380000, now(), now()),
    (20, '메타세쿼이아', 37, '양호', 'https://picsum.photos/seed/tree39/400/300', 22, 7, 36.9921000, 127.1128000, now(), now()),
