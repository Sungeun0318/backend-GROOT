...
VALUES (1, 1, 1, '진행중', '여수 공장 견적 확인 요청', '2026-04-01 00:00:00', '2026-04-03 00:00:00', NOW(), NOW()),
       (2, 2, 0, '신청', '소나무 150 그루 초기 답사', '2026-04-01', '2026-04-15', NOW(), NOW()),
       (3, 3, 1, '완료', '지점 견적 확인 요청', '2026-03-05', '2026-03-08', NOW(), NOW()),
       (4, 4, 2, '진행중', '참나무 300 그루 수량 파악', '2026-04-11', '2026-04-15', NOW(), NOW()),
       (5, 5, 0, '신청', '탄소 배출권 견적 요청', '2026-04-12', '2026-04-16', NOW(), NOW()),
       (7, 7, 0, '진행중', '시설 안전 답사 요청', '2026-04-12', '2026-04-16', NOW(), NOW()),
       (8, 8, 0, '신청', '신규 지점 견적 확인 요청', '2026-04-13', '2026-04-17', NOW(), NOW()),
       (9, 9, 3, '완료', '느티나무 100 그루 초기 답사', '2026-03-10', '2026-03-14', NOW(), NOW()),
       (10, 10, 1, '진행중', '지사 견적 확인 요청', '2026-04-13', '2026-04-17', NOW(), NOW()),
       (1, 11, 0, '신청', '마포 인근 견적 확인 요청', '2026-04-14', '2026-04-18', NOW(), NOW()),
       (2, 12, 0, '진행중', '편백나무 250 그루 수량 파악', '2026-04-14', '2026-04-18', NOW(), NOW()),
       (3, 13, 1, '완료', '대구 인근 견적 확인 요청', '2026-03-12', '2026-03-16', NOW(), NOW()),
       (4, 14, 1, '완료', '은행나무 80 그루 초기 답사', '2026-03-15', '2026-03-19', NOW(), NOW()),
       (5, 15, 0, '신청', '설비 교체 견적 요청', '2026-04-15', '2026-04-20', NOW(), NOW()),
       (6, 1, 2, '완료', '나주 공장 견적 확인 요청', '2026-03-20', '2026-03-23', NOW(), NOW()),
       (7, 16, 0, '진행중', '단풍나무 120 그루 상태 확인', '2026-04-16', '2026-04-20', NOW(), NOW()),
       (8, 17, 0, '신청', '과천 지역 견적 확인 요청', '2026-04-16', '2026-04-20', NOW(), NOW()),
       (9, 18, 0, '완료', '판교 지사 견적 확인 요청', '2026-03-22', '2026-03-26', NOW(), NOW()),
       (10, 19, 1, '진행중', '감귤나무 400 그루 초기 답사', '2026-04-17', '2026-04-21', NOW(), NOW()),
       (1, 20, 0, '신청', '평택 공장 견적 확인 요청', '2026-04-18', '2026-04-22', NOW(), NOW()),
       (2, 21, 2, '완료', '잣나무 200 그루 수량 파악', '2026-03-25', '2026-03-29', NOW(), NOW()),
       (3, 22, 1, '진행중', '당진 공장 견적 확인 요청', '2026-04-18', '2026-04-22', NOW(), NOW()),
       (4, 23, 0, '신청', '원주 지점 견적 확인 요청', '2026-04-19', '2026-04-23', NOW(), NOW()),
       (5, 24, 1, '완료', '배나무 300 그루 초기 답사', '2026-03-28', '2026-04-01', NOW(), NOW()),
       (6, 25, 1, '진행중', '익산 지사 견적 확인 요청', '2026-04-19', '2026-04-23', NOW(), NOW()),
       (7, 26, 0, '신청', '주목 150 그루 상태 확인', '2026-04-20', '2026-04-24', NOW(), NOW()),
       (8, 27, 1, '진행중', '포항 공장 견적 확인 요청', '2026-04-20', '2026-04-24', NOW(), NOW()),
       (9, 28, 0, '신청', '창원 지점 견적 확인 요청', '2026-04-21', '2026-04-25', NOW(), NOW()),
       (10, 29, 3, '완료', '측백나무 200 그루 수량 파악', '2026-03-01', '2026-03-05', NOW(), NOW()),
       (1, 30, 1, '진행중', '진주 지점 견적 확인 요청', '2026-04-21', '2026-04-25', NOW(), NOW()),
       (2, 31, 0, '신청', '소나무 350 그루 초기 답사', '2026-04-22', '2026-04-26', NOW(), NOW()),
       (3, 32, 2, '완료', '천안 지점 견적 확인 요청', '2026-03-02', '2026-03-06', NOW(), NOW()),
       (4, 33, 1, '진행중', '성남 지점 견적 확인 요청', '2026-04-22', '2026-04-26', NOW(), NOW()),
       (5, 34, 0, '완료', '상수리나무 100 그루 초기 답사', '2026-03-03', '2026-03-07', NOW(), NOW()),
       (6, 35, 0, '신청', '용인 지사 견적 확인 요청', '2026-04-23', '2026-04-27', NOW(), NOW()),
       (7, 1, 2, '진행중', '전나무 180 그루 수량 파악', '2026-04-23', '2026-04-27', NOW(), NOW()),
       (8, 2, 1, '완료', '군포 지점 견적 확인 요청', '2026-03-04', '2026-03-08', NOW(), NOW()),
       (9, 3, 0, '신청', '가문비나무 220 그루 초기 답사', '2026-04-24', '2026-04-28', NOW(), NOW()),
       (10, 4, 1, '진행중', '김포 공장 견적 확인 요청', '2026-04-24', '2026-04-28', NOW(), NOW()),
       (1, 5, 3, '완료', '느티나무 140 그루 상태 확인', '2026-03-05', '2026-03-09', NOW(), NOW()),
       (2, 6, 1, '진행중', '의왕 공장 견적 확인 요청', '2026-04-25', '2026-04-29', NOW(), NOW()),
       (3, 7, 0, '신청', '소나무 300 그루 초기 답사', '2026-04-25', '2026-04-29', NOW(), NOW()),
       (4, 8, 0, '진행중', '양주 공장 견적 확인 요청', '2026-04-26', '2026-04-30', NOW(), NOW()),
       (5, 9, 1, '완료', '자작나무 400 그루 수량 파악', '2026-03-07', '2026-03-11', NOW(), NOW()),
       (6, 10, 0, '신청', '파주 공장 견적 확인 요청', '2026-04-27', '2026-05-01', NOW(), NOW()),
       (7, 11, 2, '진행중', '벚나무 150 그루 상태 확인', '2026-04-27', '2026-05-01', NOW(), NOW()),
       (8, 12, 1, '완료', '포천 공장 견적 확인 요청', '2026-03-10', '2026-03-14', NOW(), NOW()),
       (9, 13, 0, '신청', '탄소 배출량 측정 요청', '2026-04-28', '2026-05-02', NOW(), NOW()),
       (10, 14, 1, '진행중', '기존 공장 재답사 요청', '2026-04-28', '2026-05-02', NOW(), NOW());
-- ================================= 답사정보 샘플 코드  =================================
...
values (1, '소나무', 25, '양호', 'https://picsum.photos/seed/tree1/400/300', 12, 8, 37.5665000, 126.9780000,'침엽수', now(), now()),
       (1, '소나무', 22, '양호', 'https://picsum.photos/seed/tree1/400/300', 12, 8, 37.5665000, 126.9790000,'침엽수', now(), now()),
       (1, '소나무', 21, '양호', 'https://picsum.photos/seed/tree1/400/300', 12, 8, 37.5665000, 126.9770000,'침엽수', now(), now()),
       (1, '참나무', 10, '양호', 'https://picsum.photos/seed/tree2/400/300', 14, 50, 37.5650000, 126.9815000,'침엽수' ,now(), now()),
       (1, '참나무', 30, '양호', 'https://picsum.photos/seed/tree2/400/300', 15, 10, 37.5651000, 126.9895000,'침엽수' ,now(), now()),
       (2, '은행나무', 45, '보통', 'https://picsum.photos/seed/tree3/400/300', 18, 12, 35.1796000, 129.0756000,'침엽수', now(), now()),
       (2, '벚나무', 20, '양호', 'https://picsum.photos/seed/tree4/400/300', 10, 7, 35.1802000, 129.0820000,'침엽수', now(), now()),
       (3, '단풍나무', 18, '불량', 'https://picsum.photos/seed/tree5/400/300', 8, 5, 35.8714000, 128.6014000,'침엽수', now(), now()),
       (3, '소나무', 35, '양호', 'https://picsum.photos/seed/tree6/400/300', 14, 9, 35.8722000, 128.6025000,'침엽수', now(), now()),
       (4, '느티나무', 60, '양호', 'https://picsum.photos/seed/tree7/400/300', 20, 15, 37.4563000, 126.7052000,'침엽수', now(), now()),
       (4, '참나무', 28, '보통', 'https://picsum.photos/seed/tree8/400/300', 13, 8, 37.4570000, 126.7080000,'침엽수', now(), now()),
       (5, '향나무', 22, '양호', 'https://picsum.photos/seed/tree9/400/300', 9, 6, 36.3504000, 127.3845000,'침엽수', now(), now()),
       (5, '메타세쿼이아', 40, '양호', 'https://picsum.photos/seed/tree10/400/300', 25, 7, 36.3510000, 127.3852000,'침엽수', now(),
        now()),
       (6, '소나무', 32, '보통', 'https://picsum.photos/seed/tree11/400/300', 11, 8, 35.5384000, 129.3114000,'활엽수', now(), now()),
       (6, '자작나무', 15, '양호', 'https://picsum.photos/seed/tree12/400/300', 9, 5, 35.5390000, 129.3120000,'활엽수', now(), now()),
       (7, '느티나무', 55, '양호', 'https://picsum.photos/seed/tree13/400/300', 22, 14, 37.2636000, 127.0286000, '활엽수',now(),
        now()),
       (7, '벚나무', 25, '불량', 'https://picsum.photos/seed/tree14/400/300', 10, 6, 37.2642000, 127.0300000, '활엽수',now(), now()),
       (8, '은행나무', 38, '보통', 'https://picsum.photos/seed/tree15/400/300', 16, 10, 35.1595000, 126.8526000,'활엽수', now(),
        now()),
       (8, '단풍나무', 20, '양호', 'https://picsum.photos/seed/tree16/400/300', 9, 6, 35.1600000, 126.8535000,'활엽수', now(), now()),
       (9, '참나무', 42, '양호', 'https://picsum.photos/seed/tree17/400/300', 18, 12, 33.4996000, 126.5312000,'활엽수', now(), now()),
       (9, '소나무', 27, '보통', 'https://picsum.photos/seed/tree18/400/300', 12, 7, 33.5002000, 126.5320000,'활엽수', now(), now()),
       (10, '편백', 30, '양호', 'https://picsum.photos/seed/tree19/400/300', 14, 6, 34.7604000, 127.6622000,'활엽수', now(), now()),
       (10, '향나무', 18, '양호', 'https://picsum.photos/seed/tree20/400/300', 8, 5, 34.7610000, 127.6635000,'활엽수', now(), now()),
       (11, '느릅나무', 35, '보통', 'https://picsum.photos/seed/tree21/400/300', 15, 9, 36.0190000, 129.3435000,'활엽수', now(),
        now()),
       (11, '소나무', 29, '양호', 'https://picsum.photos/seed/tree22/400/300', 13, 8, 36.0201000, 129.3442000,'활엽수', now(), now()),
       (12, '메타세쿼이아', 45, '양호', 'https://picsum.photos/seed/tree23/400/300', 28, 8, 35.8242000, 127.1480000,'활엽수', now(),
        now()),
       (12, '벚나무', 22, '보통', 'https://picsum.photos/seed/tree24/400/300', 10, 7, 35.8250000, 127.1491000,'활엽수', now(), now()),
       (13, '은행나무', 50, '양호', 'https://picsum.photos/seed/tree25/400/300', 20, 13, 36.6357000, 127.4917000,'활엽수', now(),
        now()),
       (13, '참나무', 33, '양호', 'https://picsum.photos/seed/tree26/400/300', 16, 10, 36.6365000, 127.4923000,'활엽수', now(),
        now()),
       (14, '단풍나무', 17, '불량', 'https://picsum.photos/seed/tree27/400/300', 7, 4, 35.2281000, 128.6811000,'활엽수', now(), now()),
       (14, '소나무', 36, '양호', 'https://picsum.photos/seed/tree28/400/300', 15, 9, 35.2290000, 128.6824000, '활엽수',now(), now()),
       (15, '자작나무', 20, '양호', 'https://picsum.photos/seed/tree29/400/300', 11, 6, 37.8854000, 127.7298000,'활엽수', now(),
        now()),
       (15, '느티나무', 48, '보통', 'https://picsum.photos/seed/tree30/400/300', 19, 12, 37.8861000, 127.7312000,'활엽수', now(),
        now()),
       (16, '향나무', 25, '양호', 'https://picsum.photos/seed/tree31/400/300', 10, 7, 34.9506000, 127.4872000,'활엽수', now(), now()),
       (16, '편백', 28, '양호', 'https://picsum.photos/seed/tree32/400/300', 13, 6, 34.9514000, 127.4881000,'활엽수', now(), now()),
       (17, '소나무', 31, '보통', 'https://picsum.photos/seed/tree33/400/300', 12, 8, 37.6584000, 126.8320000,'활엽수', now(), now()),
       (17, '참나무', 38, '양호', 'https://picsum.photos/seed/tree34/400/300', 17, 11, 37.6591000, 126.8335000,'활엽수', now(),
        now()),
       (18, '벚나무', 19, '양호', 'https://picsum.photos/seed/tree35/400/300', 9, 6, 36.8151000, 127.1139000,'활엽수', now(), now()),
       (18, '은행나무', 42, '보통', 'https://picsum.photos/seed/tree36/400/300', 17, 11, 36.8163000, 127.1147000,'활엽수', now(),
        now()),
       (19, '느티나무', 62, '양호', 'https://picsum.photos/seed/tree37/400/300', 23, 16, 35.9677000, 126.7369000,'활엽수', now(),
        now()),
       (19, '단풍나무', 21, '양호', 'https://picsum.photos/seed/tree38/400/300', 10, 6, 35.9685000, 126.7380000,'활엽수', now(),
        now()),
       (20, '메타세쿼이아', 37, '양호', 'https://picsum.photos/seed/tree39/400/300', 22, 7, 36.9921000, 127.1128000,'활엽수', now(),
        now()),
       (20, '소나무', 26, '불량', 'https://picsum.photos/seed/tree40/400/300', 11, 7, 36.9932000, 127.1140000, '활엽수',now(), now());
