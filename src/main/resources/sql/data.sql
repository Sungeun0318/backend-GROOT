...
VALUES
    ...
    (1, 1, 0, '승인', '답사완료', 'LG전자 강남 사옥 소규모 조경 답사', '2026-01-10', '2026-01-14', NULL, NOW(), NOW()),     -- 씨앗급
    (2, 3, 0, '승인', '답사완료', '삼성전자 수원 공장 소나무 대규모 답사', '2026-01-20', '2026-01-24', NULL, NOW(), NOW()),    -- 산림급
    (6, 5, 0, '승인', '답사완료', 'SK하이닉스 이천 캠퍼스 편백 답사', '2026-02-01', '2026-02-05', NULL, NOW(), NOW()),      -- 숲급
    (5, 8, 0, '승인', '답사완료', 'SK텔레콤 부산 물류센터 혼합 답사', '2026-02-10', '2026-02-14', NULL, NOW(), NOW()),      -- 새싹급
    (8, 9, 0, '승인', '답사완료', '두산 대구 공장 메타세쿼이아 답사', '2026-02-20', '2026-02-24', NULL, NOW(), NOW()),       -- 산림급
    (9, 11, 0, '승인', '답사완료', '네이버 성수 사옥 느티나무 가로수 답사', '2026-03-01', '2026-03-05', NULL, NOW(), NOW()),   -- 숲급
    (10, 13, 0, '승인', '답사완료', 'HD현대 인천 물류센터 소규모 조경 답사', '2026-03-10', '2026-03-14', NULL, NOW(), NOW()), -- 씨앗급
    (12, 16, 0, '승인', '답사완료', '카카오 제주 본사 벚나무 답사', '2026-03-15', '2026-03-19', NULL, NOW(), NOW()),       -- 새싹급
    (15, 19, 0, '승인', '답사완료', '기아 공항 물류센터 참나무 답사', '2026-03-25', '2026-03-29', NULL, NOW(), NOW()),      -- 숲급
    (17, 1, 0, '승인', '답사완료', 'CJ제일제당 나주 공장 대규모 조림 답사', '2026-04-01', '2026-04-05', NULL, NOW(), NOW()),  -- 산림급
    (18, 3, 0, '승인', '답사완료', 'GS칼텍스 역삼 사옥 은행나무 답사', '2026-04-05', '2026-04-09', NULL, NOW(), NOW()),     -- 새싹급
    (1, 5, 1, '승인', '답사완료', '삼성전자 성남 연구소 자작나무 답사', '2026-04-08', '2026-04-12', NULL, NOW(), NOW()),     -- 씨앗급
...
VALUES
-- ■ detail_id=1
(1, '향나무', 10, '양호', '스크린샷 2026-04-13 164152.png', 5, 3, 37.50350, 127.04460, '침엽수', now(), now()),
(1, '단풍나무', 8, '보통', 'https://groot-file.s3.ap-northeast-2.amazonaws.com/570223c5-d0fb-4c35-bf57-63884156b21f_%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7_2026-03-19_233124.png', 4, 3, 37.50351, 127.04461, '활엽수', now(), now()),
(1, '벚나무', 12, '양호', 'https://groot-file.s3.ap-northeast-2.amazonaws.com/570223c5-d0fb-4c35-bf57-63884156b21f_%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7_2026-03-19_233124.png', 6, 4, 37.50349, 127.04459, '활엽수', now(), now()),

-- ■ detail_id=2
(2, '소나무', 48, '양호', 'https://picsum.photos/seed/t04/400/300', 20, 13, 37.28610, 127.05770, '침엽수', now(), now()),
(2, '소나무', 52, '양호', 'https://picsum.photos/seed/t05/400/300', 22, 14, 37.28611, 127.05771, '침엽수', now(), now()),
(2, '소나무', 45, '보통', 'https://picsum.photos/seed/t06/400/300', 18, 12, 37.28609, 127.05771, '침엽수', now(), now()),
(2, '소나무', 50, '양호', 'https://picsum.photos/seed/t07/400/300', 21, 13, 37.28611, 127.05769, '침엽수', now(), now()),
(2, '느티나무', 40, '양호', 'https://picsum.photos/seed/t08/400/300', 16, 12, 37.28609, 127.05769, '활엽수', now(), now()),
(2, '단풍나무', 35, '보통', 'https://picsum.photos/seed/t09/400/300', 14, 10, 37.28612, 127.05770, '활엽수', now(), now()),
(2, '은행나무', 38, '양호', 'https://picsum.photos/seed/t10/400/300', 15, 11, 37.28608, 127.05770, '활엽수', now(), now()),

-- ■ detail_id=3
(3, '편백', 35, '양호', 'https://picsum.photos/seed/t11/400/300', 15, 8, 37.27500, 127.43780, '침엽수', now(), now()),
(3, '편백', 32, '양호', 'https://picsum.photos/seed/t12/400/300', 14, 7, 37.27501, 127.43781, '침엽수', now(), now()),
(3, '편백', 30, '보통', 'https://picsum.photos/seed/t13/400/300', 13, 7, 37.27499, 127.43781, '침엽수', now(), now()),
(3, '편백', 28, '양호', 'https://picsum.photos/seed/t14/400/300', 12, 6, 37.27501, 127.43779, '침엽수', now(), now()),
(3, '자작나무', 22, '양호', 'https://picsum.photos/seed/t15/400/300', 9, 5, 37.27499, 127.43779, '활엽수', now(), now()),
(3, '벚나무', 18, '보통', 'https://picsum.photos/seed/t16/400/300', 8, 5, 37.27502, 127.43780, '활엽수', now(), now()),

-- ■ detail_id=4
(4, '참나무', 14, '양호', 'https://picsum.photos/seed/t17/400/300', 7, 5, 35.09530, 128.83280, '활엽수', now(), now()),
(4, '소나무', 12, '보통', 'https://picsum.photos/seed/t18/400/300', 6, 4, 35.09531, 128.83281, '침엽수', now(), now()),
(4, '느티나무', 15, '양호', 'https://picsum.photos/seed/t19/400/300', 7, 5, 35.09529, 128.83281, '활엽수', now(), now()),
(4, '은행나무', 13, '불량', 'https://picsum.photos/seed/t20/400/300', 6, 4, 35.09530, 128.83279, '활엽수', now(), now()),

-- ■ detail_id=5
(5, '메타세쿼이아', 58, '양호', 'https://picsum.photos/seed/t21/400/300', 28, 9, 35.86980, 128.59370, '침엽수', now(), now()),
(5, '메타세쿼이아', 55, '양호', 'https://picsum.photos/seed/t22/400/300', 26, 8, 35.86981, 128.59371, '침엽수', now(), now()),
(5, '메타세쿼이아', 52, '보통', 'https://picsum.photos/seed/t23/400/300', 25, 8, 35.86979, 128.59371, '침엽수', now(), now()),
(5, '참나무', 45, '양호', 'https://picsum.photos/seed/t24/400/300', 18, 13, 35.86981, 128.59369, '활엽수', now(), now()),
(5, '느티나무', 42, '양호', 'https://picsum.photos/seed/t25/400/300', 17, 12, 35.86979, 128.59369, '활엽수', now(), now()),
(5, '소나무', 40, '보통', 'https://picsum.photos/seed/t26/400/300', 16, 10, 35.86982, 128.59370, '침엽수', now(), now()),

-- ■ detail_id=6
(6, '느티나무', 25, '양호', 'https://picsum.photos/seed/t27/400/300', 11, 8, 37.54460, 127.05690, '활엽수', now(), now()),
(6, '느티나무', 22, '양호', 'https://picsum.photos/seed/t28/400/300', 10, 7, 37.54461, 127.05691, '활엽수', now(), now()),
(6, '느티나무', 24, '보통', 'https://picsum.photos/seed/t29/400/300', 10, 7, 37.54459, 127.05691, '활엽수', now(), now()),
(6, '은행나무', 20, '양호', 'https://picsum.photos/seed/t30/400/300', 8, 6, 37.54461, 127.05689, '활엽수', now(), now()),
(6, '소나무', 18, '양호', 'https://picsum.photos/seed/t31/400/300', 8, 5, 37.54459, 127.05689, '침엽수', now(), now()),

-- ■ detail_id=7
(7, '자작나무', 9, '양호', 'https://picsum.photos/seed/t32/400/300', 4, 3, 37.44920, 126.45050, '활엽수', now(), now()),
(7, '단풍나무', 11, '보통', 'https://picsum.photos/seed/t33/400/300', 5, 3, 37.44921, 126.45051, '활엽수', now(), now()),
(7, '향나무', 8, '양호', 'https://picsum.photos/seed/t34/400/300', 4, 2, 37.44919, 126.45051, '침엽수', now(), now()),
(7, '벚나무', 10, '양호', 'https://picsum.photos/seed/t35/400/300', 5, 3, 37.44920, 126.45049, '활엽수', now(), now()),

-- ■ detail_id=8
(8, '벚나무', 15, '양호', 'https://picsum.photos/seed/t36/400/300', 7, 5, 33.45070, 126.57060, '활엽수', now(), now()),
(8, '벚나무', 13, '양호', 'https://picsum.photos/seed/t37/400/300', 6, 4, 33.45071, 126.57061, '활엽수', now(), now()),
(8, '벚나무', 12, '보통', 'https://picsum.photos/seed/t38/400/300', 5, 4, 33.45069, 126.57061, '활엽수', now(), now()),
(8, '향나무', 14, '양호', 'https://picsum.photos/seed/t39/400/300', 6, 4, 33.45070, 126.57059, '침엽수', now(), now()),

-- ■ detail_id=9
(9, '참나무', 25, '양호', 'https://picsum.photos/seed/t41/400/300', 11, 8, 37.46000, 126.44000, '활엽수', now(), now()),
(9, '참나무', 22, '양호', 'https://picsum.photos/seed/t42/400/300', 10, 7, 37.46001, 126.44001, '활엽수', now(), now()),
(9, '참나무', 20, '보통', 'https://picsum.photos/seed/t43/400/300', 9, 6, 37.45999, 126.44001, '활엽수', now(), now()),
(9, '편백', 18, '양호', 'https://picsum.photos/seed/t44/400/300', 8, 5, 37.46001, 126.43999, '침엽수', now(), now()),
(9, '소나무', 20, '양호', 'https://picsum.photos/seed/t45/400/300', 9, 6, 37.45999, 126.43999, '침엽수', now(), now()),

-- ■ detail_id=10
(10, '소나무', 50, '양호', 'https://picsum.photos/seed/t46/400/300', 20, 12, 35.01680, 126.79050, '침엽수', now(), now()),
(10, '소나무', 48, '양호', 'https://picsum.photos/seed/t47/400/300', 19, 11, 35.01681, 126.79051, '침엽수', now(), now()),
(10, '편백', 45, '양호', 'https://picsum.photos/seed/t48/400/300', 18, 10, 35.01679, 126.79051, '침엽수', now(), now()),
(10, '참나무', 42, '보통', 'https://picsum.photos/seed/t49/400/300', 17, 12, 35.01681, 126.79049, '활엽수', now(), now()),
(10, '느티나무', 40, '양호', 'https://picsum.photos/seed/t50/400/300', 16, 11, 35.01679, 126.79049, '활엽수', now(), now()),
(10, '메타세쿼이아', 55, '양호', 'https://picsum.photos/seed/t51/400/300', 26, 8, 35.01682, 126.79050, '침엽수', now(), now()),
(10, '은행나무', 35, '보통', 'https://picsum.photos/seed/t52/400/300', 14, 9, 35.01678, 126.79050, '활엽수', now(), now()),

-- ■ detail_id=11
(11, '은행나무', 16, '양호', 'https://picsum.photos/seed/t53/400/300', 7, 5, 37.50040, 127.03640, '활엽수', now(), now()),
(11, '은행나무', 14, '보통', 'https://picsum.photos/seed/t54/400/300', 6, 4, 37.50041, 127.03641, '활엽수', now(), now()),
(11, '단풍나무', 13, '양호', 'https://picsum.photos/seed/t55/400/300', 6, 4, 37.50039, 127.03641, '활엽수', now(), now()),
(11, '향나무', 12, '양호', 'https://picsum.photos/seed/t56/400/300', 5, 3, 37.50040, 127.03639, '침엽수', now(), now()),

-- ■ detail_id=12
(12, '자작나무', 12, '양호', 'https://picsum.photos/seed/t57/400/300', 6, 4, 37.40200, 127.10450, '활엽수', now(), now()),
(12, '자작나무', 10, '보통', 'https://picsum.photos/seed/t58/400/300', 5, 3, 37.40201, 127.10451, '활엽수', now(), now()),
(12, '소나무', 14, '양호', 'https://picsum.photos/seed/t59/400/300', 7, 4, 37.40199, 127.10449, '침엽수', now(), now());
