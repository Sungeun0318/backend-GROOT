...
INSERT INTO application (member_id, expert_id, times, request_status, survey_status, content, due_start_date, due_end_date, opinion, create_date, update_date)
VALUES
    ...
    (5, NULL, 0, '반려', '반려', 'SK텔레콤 해운대 지사 단풍나무 견적',        '2026-04-22', '2026-04-26', '신청하신 위치가 당사 서비스 제공 지역을 벗어나 반려합니다.', NOW(), NOW()),
    (12, NULL, 0, '반려', '반려', '카카오 판교 신사옥 조경 견적',             '2026-04-23', '2026-04-27', '조경 면적 정보가 누락되어 반려합니다. 서류 보완 후 재신청 요망.', NOW(), NOW());
...
VALUES
    (1, '2026-04-18', '2026-04-20', '학술 세미나 참석', NOW(), NOW()),
    (1, '2026-05-01', '2026-05-05', '개인 휴가', NOW(), NOW()),
