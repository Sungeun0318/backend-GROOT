...
VALUES
    ...
    (1, '향나무', 10, '양호', '스크린샷 2026-04-13 164152.png', 5, 3, 37.5035, 127.0446, '침엽수', now(), now()),
    (1, '단풍나무', 8, '보통', 'https://groot-file.s3.ap-northeast-2.amazonaws.com/570223c5-d0fb-4c35-bf57-63884156b21f_%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7_2026-03-19_233124.png', 4, 3, 37.5036, 127.0445, '활엽수', now(), now()),
    (1, '벚나무', 12, '양호', 'https://groot-file.s3.ap-northeast-2.amazonaws.com/570223c5-d0fb-4c35-bf57-63884156b21f_%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7_2026-03-19_233124.png', 6, 4, 37.5034, 127.0447, '활엽수', now(), now()),
