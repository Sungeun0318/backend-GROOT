...
VALUES
    ...
    (2, 3, 1, '승인', '답사완료', '삼성전자 수원 공장 소나무 대규모 답사', '2026-01-20', '2026-01-24', NULL, NOW(), NOW()),    -- 산림급
    (6, 5, 0, '승인', '답사완료', 'SK하이닉스 이천 캠퍼스 편백 답사', '2026-02-01', '2026-02-05', NULL, NOW(), NOW()),      -- 숲급
    (5, 8, 2, '승인', '답사완료', 'SK텔레콤 부산 물류센터 혼합 답사', '2026-02-10', '2026-02-14', NULL, NOW(), NOW()),      -- 새싹급
    (8, 9, 0, '승인', '답사완료', '두산 대구 공장 메타세쿼이아 답사', '2026-02-20', '2026-02-24', NULL, NOW(), NOW()),       -- 산림급
    (9, 11, 1, '승인', '답사완료', '네이버 성수 사옥 느티나무 가로수 답사', '2026-03-01', '2026-03-05', NULL, NOW(), NOW()),   -- 숲급
    (10, 13, 0, '승인', '답사완료', 'HD현대 인천 물류센터 소규모 조경 답사', '2026-03-10', '2026-03-14', NULL, NOW(), NOW()), -- 씨앗급
    (12, 16, 1, '승인', '답사완료', '카카오 제주 본사 벚나무 답사', '2026-03-15', '2026-03-19', NULL, NOW(), NOW()),       -- 새싹급
    (15, 19, 0, '승인', '답사완료', '기아 공항 물류센터 참나무 답사', '2026-03-25', '2026-03-29', NULL, NOW(), NOW()),      -- 숲급
    (17, 1, 2, '승인', '답사완료', 'CJ제일제당 나주 공장 대규모 조림 답사', '2026-04-01', '2026-04-05', NULL, NOW(), NOW()),  -- 산림급
    (18, 3, 0, '승인', '답사완료', 'GS칼텍스 역삼 사옥 은행나무 답사', '2026-04-05', '2026-04-09', NULL, NOW(), NOW()),     -- 새싹급
    (19, 5, 1, '승인', '답사완료', '삼성전자 성남 연구소 자작나무 답사', '2026-04-08', '2026-04-12', NULL, NOW(), NOW()),     -- 씨앗급

    -- 진행중 4건 (detail_id 13~16)
    (1, 15, 3, '승인', '답사진행중', 'LG전자 평택 공장 2차 조경 답사', '2026-04-10', '2026-04-14', NULL, NOW(), NOW()),
    (14, 11, 2, '승인', '답사진행중', '네이버 가산 사옥 향나무 조경 답사', '2026-04-11', '2026-04-15', NULL, NOW(), NOW()),
    (13, 7, 3, '승인', '답사진행중', '삼성전자 울산 공장 탄소흡수 답사', '2026-04-12', '2026-04-16', NULL, NOW(), NOW()),
    (20, 19, 2, '승인', '답사진행중', '두산 음성 공장 단풍나무 답사', '2026-04-13', '2026-04-17', NULL, NOW(), NOW()),
    ...
    (5, NULL, 0, '반려', '', 'SK텔레콤 해운대 지사 단풍나무 견적', '2026-04-22', '2026-04-26', '신청하신 위치가 당사 서비스 제공 지역을 벗어나 반려합니다.',
     NOW(), NOW()),
    (12, NULL, 0, '반려', '', '카카오 판교 신사옥 조경 견적', '2026-04-23', '2026-04-27', '조경 면적 정보가 누락되어 반려합니다. 서류 보완 후 재신청 요망.',
     NOW(), NOW());
